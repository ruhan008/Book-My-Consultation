package com.bookmyconsultation.ratingservice.configuration;
...
public class KafkaProducerConfiguration {
    ...
    @Bean
    ProducerFactory<String, DoctorRating> producerFactory(){
    ...
    @Bean
    public KafkaTemplate<String,DoctorRating> kafkaTemplate(){
